...
contract ProtocolRewards is IProtocolRewards, EIP712 {
     ...
     * @param reason Reason system reason for deposit (used for indexing)
    ...
    function depositRewards(
        ...
        if (msg.value != (builderReferralReward + purchaseReferralReward + revolutionReward)) revert INVALID_DEPOSIT();
