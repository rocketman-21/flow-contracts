...
/**
 * @dev MODIFICATIONS
 * Checkpointing logic from ERC20VotesUpgradeable.sol has been used with the following modifications:
...
abstract contract ERC20VotesUpgradeable is Initializable, ERC20PermitUpgradeable, IERC5805Upgradeable {
    ...
    function delegates(address account) public view virtual override returns (address) {
        return _delegates[account] == address(0) ? account : _delegates[account]; // modified
    }
