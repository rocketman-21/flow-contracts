...
import { ISuperfluid, BatchOperation, IConstantFlowAgreementV1, IGeneralDistributionAgreementV1, ISuperToken, ISuperfluidPool } from "@superfluid-finance/ethereum-contracts/contracts/interfaces/superfluid/ISuperfluid.sol";
    ...
    IUserDefinedMacro
{
    ...
    function buildBatchOperations(
        ...
        ISuperfluid.Operation[] memory baselineOps = _buildPoolOperations(host, fs.baselinePool, msgSender);
        ISuperfluid.Operation[] memory bonusOps = _buildPoolOperations(host, fs.bonusPool, msgSender);
